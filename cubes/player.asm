...
usecode		= $1009C5F ; $9C5F
;usecode	= $200B508	; eldorado


editor_efx=1	; 1 to play EFx (Invert Loop) like ProTracker does in the
...
InitMusic:
	lea	Song, a0			; init P61 format tracker module
	moveq	#0, d0				; if CIA=1: 1=PAL,2=NTSC,0=auto (only if exec=1)
	move.l	#0, a1				; no external samples
	lea	Samples, a2			; if crunched samples, samplebuffer address
	;move.l	#0, a2
	jmp	P61_Init			; trashes all but a6, d0=0 on return if ok
