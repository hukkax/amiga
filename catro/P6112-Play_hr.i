...
; modified by hukka to also call P61_funk2 on the first tick
; fix/optimization by ross
;
P61_funk:
	; from Porotracker:
	; n_glissfunk := ((Note.Parameter and $0F) shl 4) or (n_glissfunk and $0F)
	;if (ch.n_glissfunk and $F0) <> 0 then UpdateFunk(ch)
	...
	beq.w P61_fxdone
	bset d7,P61_firstframe(a5)

P61_funk2:
	moveq #0,d0
	move.b P61_Funkspd(a5),d0
	beq.b P61_funkend		; if (funkspeed = 0) then Exit
	move.b P61_FunkTable(pc,d0),d0
	add.b d0,P61_Funkoff(a5)	; Inc(ch.n_funkoffset, FunkTable[funkspeed]);

	bpl.b P61_funkend		; if (ch.n_funkoffset < 128) then Exit
	move.b d7,P61_Funkoff(a5)	; n_funkoffset := 0

	move.l P61_Wave(a5),d0
	beq.b P61_funkend		; if (ch.n_wavestart = 0) then Exit
	movea.l d0,a0
	move.l P61_Sample(a5),a1
	...
	add.l d0,d0
	add.l d1,d0
	addq.l	#1,a0			; Inc(ch.n_wavestart)
	cmp.l d0,a0
	blo.b P61_funkok
	move.l d1,a0
P61_funkok:
